...
def assistantResponse(text):
    ...
    myobj.save('ASSITANT_Response.mp3')

    os.system('start ASSITANT_Response.mp3')

def wakeWords(text):
    WAKE_WORDS = ['hey buddy' , 'okay buddy']
...
def greeting(text):
    ...
    GREETING_INPUTS = ['hi', 'salam' , 'hey' , 'alo' , 'haji' , 'hello']

    GREETING_RESPONSES = ['whats good', 'hey there' , 'nokaram', 'hello']
